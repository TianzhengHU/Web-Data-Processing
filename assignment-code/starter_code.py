...
from relation_extraction import process_relation_extraction
# import output_form
from output_form import predict_format
...
def find_relations(payload, entities):
    ...
    '''
    We trained a SVM model to extracte relation between entities and their links
    '''
...
if __name__ == '__main__':
    ...
    print('------------------start preprocessing and NER--------------')
    preprocessing(INPUT)
    print('------------------finish preprocessing and NER--------------')
    print('------------------start entity linking--------------')
    entity_linking()
    print('------------------finish entity linking--------------')
    print('------------------start relation extraction--------------')
    process_relation_extraction()
    print('------------------finish relation extraction--------------')
    print('------------------start output predcitions--------------')
    predict_format()
    print('------------------finish output predcitions--------------')
